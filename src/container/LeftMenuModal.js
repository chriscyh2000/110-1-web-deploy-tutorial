...
import { AppstoreOutlined, SettingOutlined, StarOutlined, HeartOutlined, SmileOutlined, EnvironmentOutlined, HomeOutlined, PlusSquareFilled, PlusSquareOutlined } from '@ant-design/icons';
...
export default function LeftMenuModal(props) {
    ...
    return (
        ...
        >
            ...
            <Menu.Item key="my" icon={<PlusSquareOutlined />}>my post</Menu.Item>
